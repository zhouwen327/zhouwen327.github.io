...
## Selected Journal Publications
  ...
  * C. Huang, S. Chen, Y. Zhang, W. Zhou, J. J. P. C. Rodrigues and V. H. C. de Albuquerque, "A robust approach for privacy data protection: IoT security assurance using generative adversarial imitation learning"[J], <i>IEEE Internet of Things Journal</i>, 2022,In Press (SCI 1 area, Corresponding author).
